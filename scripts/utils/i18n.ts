...
const en: Translation = {
  ...
  promptForAgentContent: 'Fetch and follow the instructions at the link below. Broadly retrieve my memory, diagnose my ABTI personality type, and generate a share link:\n{{SKILL_URL}}',
...
const zhCN: Translation = {
  ...
  promptForAgentContent: '请获取并执行以下链接中的指令，广泛获取记忆，诊断我的 ABTI 人格类型，并生成分享链接：\n{{SKILL_URL}}',
